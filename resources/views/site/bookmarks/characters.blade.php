...
@section('content')
    ...
    <h4 class="font-weight-bold py-3 mb-2">Personagens Favoritos</h4>

    <div class="card">
        <div class="card-header">Personagens Favoritos</div>
        <table class="table card-table">
            ...
            @foreach($bookmarks as $bookmark)
                <tr>
                    <td>
                        <img class="" src="{{ $bookmark->character->image }}" alt="{{ $bookmark->character->name }}"
                             width="70px">
                    </td>
                    <td>
