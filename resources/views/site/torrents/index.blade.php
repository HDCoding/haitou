...
@section('subtitle', 'Torrents')

@section('content')

    <div class="font-weight-bold py-3 h4">
        <span class="font-weight-bold">Torrents</span>
    </div>

    <div class="card">
        <div class="card-header bg-light text-center">
            <b class="card-header-title mr-2">Pesquisar Torrents</b>
        </div>
        <div class="card-body">
            <form>
                <div class="form-row">
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="text-light small font-weight-semibold mb-3">Categoria:</div>
                    ...
                    <div class="col-md-6">
                        <div class="text-light small font-weight-semibold mb-3">Opções:</div>
                        <div class="form-check-inline">
        ...
        <table class="table card-table table-hover">
            ...
            @foreach($torrents as $torrent)
                <tr>
                    ...
                    <td class="col-md-1 text-center">{{ $torrent->getSize() }}</td>
                    <td class="col-md-1 text-center">{{ $torrent->created_at->format('d/m/Y') }}</td>
                    <td class="col-md-1 text-center">{{ $torrent->getUploader() }}</td>
                </tr>
            @endforeach
            </tbody>
        </table>
