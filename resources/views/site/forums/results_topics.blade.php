                                ...
                                <div class="container well search mt-5 fatten-me table-me"
                                    ...
                                    <form role="form" method="GET" action="{{ route('forum.search') }}" class="form-horizontal form-condensed form-torrent-search form-bordered table-me">
                                        <div class="mx-0 mt-5 form-group fatten-me">
                                            <label for="name" class="mt-5 col-sm-1 label label-default fatten-me">
                                                Tópico
                                            </label>
                                            <div class="col-sm-9 fatten-me">
                                                <label>
                                                    <input type="text" name="name" placeholder="Tópico"
                                        ...
                                        <div class="mx-0 mt-5 form-group fatten-me">
                                            <label for="body" class="mt-5 col-sm-1 label label-default fatten-me">
                                                Post
                                            </label>
                                            <div class="col-sm-9 fatten-me">
                                                <label>
                                        ...
                                        <div class="mx-0 mt-5 form-group fatten-me">
                                            <label for="sort" class="mt-5 col-sm-1 label label-default fatten-me">
                                                Fórum
                                            </label>
                                            <div class="col-sm-9 fatten-me">
                                                        ...
                                                        @if ($category->getPermission() != null && $category->getPermission()->show_forum == true && $category->getForumsInCategory()->count() > 0)
                                                            ...
                                                            @foreach ($category->getForumsInCategory()->sortBy('position') as $categoryChild)
                                                                @if ($categoryChild->getPermission() != null && $categoryChild->getPermission()->show_forum == true)
                                                                    <option value="{{ $categoryChild->id }}" {{ (isset($params) && is_array($params) && array_key_exists('category',$params) && $params['category'] == $categoryChild->id ? 'SELECTED' : '') }}>
                                        ...
                                        <div class="mx-0 mt-5 form-group fatten-me">
                                            <label for="type" class="mt-5 col-sm-1 label label-default fatten-me">
                                                Rótulo
                                            </label>
                                            <div class="col-sm-10">
                                        ...
                                        <div class="mx-0 mt-5 form-group fatten-me">
                                            <label for="type" class="mt-5 col-sm-1 label label-default fatten-me">Atividade</label>
                                            <div class="col-sm-10">
                                                <span class="badge-user">
                                                    <label class="inline">
                                                        @if(isset($params) && is_array($params) && array_key_exists('subscribed', $params) && $params['subscribed'] == 1)
                                                            <input type="checkbox" value="1" name="subscribed" checked> <span
                                                                class="fa fa-bell text-green"></span> Subscrito
                                                        @else
                                                ...
                                                <span class="badge-user">
                                                    <label class="inline">
                                                        @if(isset($params) && is_array($params) && array_key_exists('notsubscribed', $params) && $params['notsubscribed'] == 1)
                                                            <input type="checkbox" value="1" name="notsubscribed" checked> <span
                                                                class="fa fa-bell-slash text-red"></span> Não inscrito
                                                        @else
                ...
                @foreach ($results as $r)
                    <tr>
                        ...
                        <td class="f-display-topic-title">
                            <strong>
                                <a href="{{ route('forum_topic', ['id' => $r->topic->id, 'slug' => $r->topic->slug]) }}">
                                    {{ $r->topic->name }}
                                </a>
                            </strong>
                        ...
                        <td class="f-display-topic-started">
                            <a href="{{ route('user.profile', ['name' => Str::slug($r->topic->first_post_user_name)]) }}">
                                {{ $r->topic->first_post_user_name }}
                            </a>
                        </td>
                        ...
                        <td class="f-display-topic-last-post">
                            <a href="{{ route('user.profile', ['name' => Str::slug($r->topic->last_post_user_name)]) }}">
                                {{ $r->topic->last_post_user_name }}
                            </a>,
                                    ...
                                    <div class="post" id="post-{{$r->id}}">
                                        <div class="button-holder">
                                            <div class="button-left">
                                                <a href="{{ route('user.profile', ['name' => Str::slug($r->user->name)]) }}"
                                                   class="post-info-name"
                                                   style="color:{{ $r->user->group->color }}; display:inline;">{{ $r->user->name }}</a>
