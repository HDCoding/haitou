        ...
        <div class="navbar-header">
            ...
            <a class="navbar-brand" href="{{ url('home') }}">
                ...
                <b class="logo-icon">
                    ...
                    <!-- Dark Logo icon -->
                    <img src="{{ secure_asset('images/favicons/android-icon-36x36.png') }}" alt="homepage" class="dark-logo"/>
                    <!-- Light Logo icon -->
                    <img src="{{ secure_asset('images/favicons/android-icon-36x36.png') }}" alt="homepage" class="light-logo"/>
                </b>
                <!--End Logo icon -->
                <!-- Logo text -->
                <span class="logo-text">
                    ...
                    <img src="{{ secure_asset('images/favicons/android-icon-36x36.png') }}" alt="homepage" class="dark-logo"/>
                    <!-- Light Logo text -->
                    <img src="{{ secure_asset('images/logo-text.png') }}" class="light-logo" alt="homepage"/>
                </span>
            </a>
            <!-- ============================================================== -->
            <!-- End Logo -->
