        ...
        <div class="tab-content" id="pills-tabContent">
            ...
            <div class="tab-pane fade p-15" id="pills-contact" role="tabpanel" aria-labelledby="pills-contact-tab">
                ...
                <div class="steamline">
                    ...
                    <div class="sl-item">
                        <div class="sl-left">
                            <img src="{{ secure_asset('images/status/heart.png') }}" class="img-rounded" alt="Points">
                        </div>
                        <div class="sl-right">
                    ...
                    <div class="sl-item">
                        <div class="sl-left">
                            <img src="{{ secure_asset('images/status/warned.png') }}" class="img-rounded" alt="Warned">
                        </div>
                        <div class="sl-right">
                    ...
                    <div class="sl-item">
                        <div class="sl-left">
                            <img src="{{ secure_asset('images/status/ratio.png') }}" class="img-rounded" alt="Ratio">
                        </div>
                        <div class="sl-right">
                    ...
                    <div class="sl-item">
                        <div class="sl-left">
                            <img src="{{ secure_asset('images/status/downloaded.png') }}" class="img-rounded" alt="Downloaded">
                        </div>
                        <div class="sl-right">
                    ...
                    <div class="sl-item">
                        <div class="sl-left">
                            <img src="{{ secure_asset('images/status/uploaded.png') }}" class="img-rounded" alt="Uploaded">
                        </div>
                        <div class="sl-right">
