                ...
                <div class="d-flex align-items-center">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">Advertir</li>
                        </ol>
                    </nav>
                </div>
            </div>
                    ...
                    <div class="card-body">
                        ...
                        <div class="block">
                            <div class="block-content">
                                ...
                                {!! Form::open(['url' => 'staff/user/warning', 'class' => 'form-horizontal']) !!}
                                ...
                                <br>
                                {!! Form::submit('Advertir', ['class' => 'btn btn-success btn-rounded btn-outline']) !!}
                                {!! Form::close() !!}
