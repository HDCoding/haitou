                                            ...
                                            <div class="btn-group">
                                                ...
                                                <div class="btn-group">
                                                    ...
                                                    <ul class="dropdown-menu">
                                                        ...
                                                        <li>
                                                            {{--<a href="javascript:;" onclick="document.getElementById('user-del-{{ $user->id }}').submit();" class="btn btn-xs" type="button" data-toggle="tooltip" title="Remover Usuário"><i class="fa fa-times text-danger"></i></a>--}}
