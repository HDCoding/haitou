    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-lg-8">
                ...
                <div class="card">
                    <div class="card-body">
                        <h4 class="card-title">Solução: <span class="text-muted">{{ format_date_time($report->updated_at) }}</span></h4>
            ...
            <div class="col-lg-4">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <span>
                            <a href="{{ url('calendars/' . $report->calendar->id . '.'. $report->calendar->slug) }}" target="_blank">
