                                    ...
                                    <div class="card mb-5">
                                        <div class="card-header with-elements">
                                            ...
                                            <div class="card-header-elements ml-md-auto">
                                                <a href="{{ url('staff/categories/' . $category->id . '/edit') }}" class="btn btn-xs" type="button" data-toggle="tooltip" title="Editar Categoria"><i class="fa fa-pencil-alt text-info"></i></a>
                                                <a href="javascript:;" onclick="document.getElementById('category-del-{{ $category->id }}').submit();" class="btn btn-xs" type="button" data-toggle="tooltip" title="Remover Categoria"><i class="fa fa-times text-danger"></i></a>
