            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        {!! Form::model($sitepot, ['url' => ['staff/freeslots/' . $sitepot->id], 'method' => 'PUT', 'class' => 'form-horizontal']) !!}
                        <div class="form-group">
                            <label class="form-label">Título</label>
                            {!! Form::text('name', $sitepot->name, ['class' => 'form-control', 'required', 'maxlength' => 250]) !!}
                        </div>

                        <div class="form-group">
                            <label class="form-label">Necessário</label>
                            {!! Form::number('required', $sitepot->required, ['class' => 'form-control', 'required', 'min' => 1000, 'max' => 2000000000]) !!}
                        </div>
                        <div class="col-xs-12 push-15">
                            <div class="push-5">
                        ...
                        <div class="form-group">
                            ...
                            {!! Form::number('days', $sitepot->days, ['class' => 'form-control', 'required', 'min' => 1, 'max' => 125]) !!}
                        </div>
                        <div class="col-xs-12 push-15">
                            <div class="push-5">
                        ...
                        <div class="form-group form-inline row mt-2">
                            ...
                            <label class="custom-control custom-checkbox ml-3 mr-5">
                                {!! Form::checkbox('is_freeleech', 1, $sitepot->is_freeleech, ['class' => 'custom-control-input']) !!}
                                <span class="custom-control-label">Freeleech</span>
                            </label>
                            <label class="custom-control custom-checkbox mr-5">
                                {!! Form::checkbox('is_silver', 1, $sitepot->is_silver, ['class' => 'custom-control-input']) !!}
                                <span class="custom-control-label">Silver</span>
                            </label>
                            <label class="custom-control custom-checkbox">
                                {!! Form::checkbox('is_doubleup', 1, $sitepot->is_doubleup, ['class' => 'custom-control-input']) !!}
