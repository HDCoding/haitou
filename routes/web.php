...
//Legal
Route::get('terms', 'IndexesController@terms')->name('terms');
Route::get('privacy', 'IndexesController@privacy')->name('privacy');
...
//        Route::post('/topico/{id}.{slug}/add-poll', 'ForumsController@topicSavePoll')->name('topic.save.poll');
    ...
    //Friendship
    Route::get('friendships', 'FriendshipsController@friendships')->name('friendships');
    Route::get('friends', 'FriendshipsController@friends')->name('friends');
    Route::get('befriend/{id}', 'FriendshipsController@befriend')->name('befriend');
    Route::get('unfriend/{id}', 'FriendshipsController@unfriend')->name('unfriend');
    Route::get('acceptFriend/{id}', 'FriendshipsController@acceptFriend')->name('acceptFriend');
    Route::get('denyFriend/{id}', 'FriendshipsController@denyFriend')->name('denyFriend');
    Route::get('blockFriend/{id}', 'FriendshipsController@blockFriend')->name('blockFriend');
    Route::get('unblockFriend/{id}', 'FriendshipsController@unblockFriend')->name('unblockFriend');
...
Route::namespace('Staff')->group(function () {
    ...
    Route::prefix('staff')->group(function () {
        ...
        Route::post('user/ban', 'UsersController@postBan');
        //Suspend user
        ...
        Route::post('user/warn', 'UsersController@postWarn');
        //Notes user
